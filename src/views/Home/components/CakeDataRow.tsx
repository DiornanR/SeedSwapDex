...
const CakeDataRow = () => {
  ...
  const {
   ...
   // const totalSupplyCall = { address: tokens.seed.address, name: 'totalSupply' }
      const burnedTokenCall = { address: tokens.cake.address, name: 'balanceOf', params: ['0x000000000000000000000000000000000000dEaD'], }
      /*
      const burnedTokenCall = { address: tokens.seed.address, name: 'balanceOf', params: ['0x000000000000000000000000000000000000dEaD'], }
      */
