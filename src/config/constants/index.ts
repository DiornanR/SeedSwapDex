...
export const EXCHANGE_DOCS_URLS = 'https://docs.seedswap.finance/products/seedswap-exchange'
export const LIMIT_ORDERS_DOCS_URL = 'https://docs.seedswap.finance/products/seedswap-exchange/limit-orders'
